...
$$
\begin{aligned}
R^2_{gx} > R^2{gy} & \Rightarrow \frac{\beta_{gx}^2 \sigma^2_g} {\beta_{gx}^2 \sigma^2_g + \beta_{ux}^2 \sigma^2_u + \sigma^2_{e_x}} > \frac{\beta_{gx}^2\beta_{xy}^2 \sigma^2_g} {\beta_{xy}^2\beta_{gx}^2 \sigma^2_g + \sigma^2_u (\beta_{xy} \beta_{ux}+\beta_{uy})^2 + \beta_{xy}^2 \sigma^2_{e_x} + \sigma^2_{e_y}} \\
...
Finally, as an alternative to reporting an overall probability, analysts can evaluate the confounding parameters that would be required to give rise to the opposing causal direction to evaluate their plausibility.
